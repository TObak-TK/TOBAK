...
sudo_users = {SUDO,648027560,bot_id}
...
local TOBAK_Msg = ''  
if msgs > 100 then 
TOBAK_Msg = 'تفاعلك زفت' 
elseif msgs > 200 then 
TOBAK_Msg = 'شويه شدها' 
elseif msgs > 300 then 
TOBAK_Msg = 'شبه متفاعل ' 
elseif msgs > 600 then 
TOBAK_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
TOBAK_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
TOBAK_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
TOBAK_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
TOBAK_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
TOBAK_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
TOBAK_Msg = 'طاك' 
elseif msgs > 7000 then 
TOBAK_Msg = 'يطك بالكاع' 
...
--------------------------------------------------------------------------------------------------------------
function SourceTOBAK(msg,data) -- بداية العمل
if msg then
...
if SudoBot(msg) then
local bl =  '-  𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝐓𝐨𝐛𝐚𝐤 المطور الاساسي \n سورس توباك \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/Nodals) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝐓𝐨𝐛𝐚𝐤 \n سيتم الرد عليك قريبا')
...
send(msg.chat_id_, msg.id_,'• عدد القروبات الان > { '..#group..' }'..TOBAKk..''..TOBAK..'\n*• الان عدد القروبات الحقيقي > { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'Nodals')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'Nodals')..') '
status  = '\n تم ترقيته مطور في البوت'
...
if TOBAK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nodals')..') \n •'..TOBAK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/Nodals)}\n•["..TOBAK_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/Nodals)}\n• الملصق الذي ارسلته تم منعه من القروب \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:set(bot_id.."TOBAK:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."TOBAK:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."TOBAK:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TOBAK:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."TOBAK:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."TOBAK:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TOBAK:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."TOBAK:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."TOBAK:age_Bots"..msg.chat_id_) == "open" then
local Textage = text:match("^احسب (.*)$")
ge = https.request('https://mode-dev.tk/Api1/TOBAKapi.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Nodals','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
if name_Black then 
names_Black = database:smembers(bot_id.."TOBAK:blocname"..msg.chat_id_) or ""
...
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."TOBAK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TOBAK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."TOBAK:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."TOBAK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
Text = [[
╭• [𝐓𝐨𝐛𝐚𝐤 𝑺𝑶𝑼𝑹𝑺𝑬](t.me/Nodals) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس توباك' or text == 'اريد بوت تمبلر' or text == 'سورس توباك' then
Text = [[
•- DEV @D6D6I مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
Text = [[
اهلا عزيزي
متوفر تنصيب بوتات ع سورس توباك
احدث واسرع البوتات وضمان الثقه
للاستفسار راسل المطور @D6D6I
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '@D6D6I' or text == '@Nodals' or text == 'علش سعدي' then
Text = [[
@D6D6I هذا مطور سورس توباك
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nodals')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Nodals')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nodals')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Nodals')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
send(msg.chat_id_, msg.id_, "•لا يمكن  حظر مبرمج السورس \n")
return false 
end
...
local UserName = (b.username_ or "Nodals")
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝐓𝐨𝐛𝐚𝐤 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
t = "\n•قائمة المنع \n *•●○●○●○●•ٴ*\n"
for k,v in pairs(list) do  
local TOBAK_Msg = database:get(bot_id.."TOBAK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." > {"..TOBAK_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'Nodals')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'TOBAK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'TOBAK:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'TOBAK')..') '
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/Nodals) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝐓𝐨𝐛𝐚𝐤 - SoUrCe](https://t.me/Nodals)
]]
...
if not database:get(bot_id..'TOBAK:Reply:Mute'..msg.chat_id_) then
...
database:del(bot_id..'TOBAK:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Sre:stats") then
database:set(bot_id..'TOBAK:Reply:Mute'..msg.chat_id_,true)
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/Nodals)}\n•["..TOBAKAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
